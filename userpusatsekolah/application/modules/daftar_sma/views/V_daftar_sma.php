    ...
    <section class="parallax-section single-par" data-scrollax-parent="true">
        ...
        <div class="container">
            <div class="section-title center-align big-title">
                <h2><span>Daftar Sekolah Menengah Atas</span></h2>
                <span class="section-separator"></span>
                <h4>Kami akan menampilkan seluruh daftar Sekolah Menengah Atas sesuai dengan apa yang Anda pilih.</h4>
            </div>
                                        ...
                                        <div class="geodir-category-content fl-wrap title-sin_item">
                                            <div class="geodir-category-content-title fl-wrap">
                                                <div class="geodir-category-content-title-item">
                                                    <br>
                                                    <h3 class="title-sin_map"><a href="<?php echo base_url('daftar_sma/detailsekolah/'.$rowS->id_p_sekolah); ?>"><?php echo $rowS->nama_sekolah;?></a><!--<span class="verified-badge"><i class="fal fa-check"></i>--></span></h3>
