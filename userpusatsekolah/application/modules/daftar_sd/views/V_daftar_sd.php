                                        ...
                                        <div class="geodir-category-content fl-wrap title-sin_item">
                                            <div class="geodir-category-content-title fl-wrap">
                                                <div class="geodir-category-content-title-item">
                                                    <br>
                                                    <h3 class="title-sin_map"><a href="<?php echo base_url('daftar_sd/detailsekolah/'.$rowS->id_p_sekolah); ?>"><?php echo $rowS->nama_sekolah;?></a><!--<span class="verified-badge"><i class="fal fa-check"></i>--></span></h3>
