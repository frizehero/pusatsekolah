...
<!-- Mirrored from townhub.kwst.net/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Mar 2021 07:55:12 GMT -->

<head>
    <!--=============== basic  ===============-->
    <meta charset="UTF-8">
    <title>Pusat Sekolah - SD</title>
        ...
        <div id="wrapper">
            ...
            <div class="content">
                ...
                <section class="parallax-section single-par" data-scrollax-parent="true">
                    <div class="bg par-elem " data-bg="images/sekolah/sd1.jpg" data-scrollax="properties: { translateY: '30%' }"></div>
                    <div class="overlay op7"></div>
                    <div class="container">
                        <div class="section-title center-align big-title">
                            <h2><span>Daftar Sekolah Dasar</span></h2>
                            <span class="section-separator"></span>
                            <h4>Kami akan menampilkan seluruh daftar Sekolah Dasar sesuai dengan apa yang Anda pilih.</h4>
                        </div>
                    </div>
...
<!-- Mirrored from townhub.kwst.net/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Mar 2021 07:55:17 GMT -->
