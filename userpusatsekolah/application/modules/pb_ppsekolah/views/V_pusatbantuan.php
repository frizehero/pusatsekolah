                    ...
                    <div class="col-md-4">
                        ...
                        <div class="faq-section fl-wrap">
                            ...
                            <div class="accordion">
                                ...
                                <a class="toggle act-accordion" href="#pendaftaranpengaturansekolah" style="font-size: 17px;">Info Umum<span></span></a>
                                    ...
                                    <div class="list-author-widget-contacts list-item-widget-contacts">
                                        <ul class="no-list-style">
                                            ...
                                            <li style="background-color: #f9f6f6; padding: 15px 0px 15px 0px;">
                                                <a href="#pendaftaranpengaturansekolah" class="custom-scroll-link" style="color: #384F95; font-size: 15px;">Pendaftaran & Pengaturan Sekolah</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
