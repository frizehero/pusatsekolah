        ...
        <div class="container">
            <div class="list-single-header-item  fl-wrap">
                <div class="row">
                    <div class="col-md-9">
                        <h1>PPDB Sekolah</h1>
                        <div class="geodir-category-location fl-wrap"><a href="#"><i class="fas fa-map-marker-alt"></i>  Las Encitas High School, Elm Nortside St No. 80, Indonesia</a> <a href="#"> <i class="fal fa-phone"></i>+628099231212</a> <a href="#"><i class="fal fa-envelope"></i> lasencitashigh@gmail.com </a></div>
                    </div>
                    <div class="col-md-3">
                    </div>
                </div>
                                ...
                                <div class="single-slider fl-wrap">
                                    <div class="swiper-container">
                                        <div class="swiper-wrapper lightgallery">
                                            <div class="swiper-slide hov_zoom"><img src="images/bg/42.png" alt=""><a href="images/bg/42.png" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a></div>
                                            <div class="swiper-slide hov_zoom"><img src="images/bg/43.png" alt=""><a href="images/bg/43.png" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a></div>
                                            <div class="swiper-slide hov_zoom"><img src="images/bg/44.jpg" alt=""><a href="images/bg/44.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a></div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="box-widget">
                            ...
                            <div class="box-widget-content bwc-nopad">
                                <div class="list-author-widget-contacts list-item-widget-contacts bwc-padside">
                                    <ul class="no-list-style">
                                        <li><span><i class="fal fa-map-marker"></i> Alamat :</span> <a href="#">Elm Nortside St No. 80, Indonesia</a></li>
                                        <li><span><i class="fal fa-phone"></i> Telephone :</span> <a href="#">+6289876547568</a></li>
                                        <li><span><i class="fal fa-envelope"></i> Email :</span> <a href="#">lasencitashigh@gmail.com</a></li>
                                        <li><span><i class="fal fa-browser"></i> Website :</span> <a href="#">www.lasencitashigh.com</a></li>
                                    </ul>
                                </div>
                                <div class="list-widget-social bottom-bcw-box  fl-wrap">
                                    ...
                                    <div class="bottom-bcw-box_link"><a href="#" class="show-single-contactform tolt" data-microtip-position="top" data-tooltip="Kirim Pesan"><i class="fal fa-envelope"></i></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <ul class="no-list-style">
                                        <li>
                                            ...
                                            <div class="widget-posts-descr">
                                                <h4><a href="listing-single.html">Data Guru</a></h4>
                                        ...
                                        <li>
                                            ...
                                            <div class="widget-posts-descr">
                                                <h4><a href="listing-single.html">Data Alumni</a></h4>
                                        ...
                                        <li>
                                            ...
                                            <div class="widget-posts-descr">
                                                <h4><a href="listing-single.html">Event Sekolah</a></h4>
                                        ...
                                        <li>
                                            ...
                                            <div class="widget-posts-descr">
                                                <h4><a href="listing-single.html">Produk Sekolah</a></h4>
