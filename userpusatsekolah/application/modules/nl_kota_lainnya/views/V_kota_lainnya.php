            ...
            <section style="padding-top: 20px; padding-bottom: 10px;">
                    <div class="listing-item-grid_container fl-wrap">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="listing-item-grid">
                                    <div class="bg"  data-bg="images/sekolah/Probolinggo.jpg"></div>
                                    <div class="d-gr-sec"></div>
                                    <div class="listing-counter color2-bg"><span>69 </span> Sekolah Terdaftar</div>
                                    <div class="listing-item-grid_title">
                                        <h3><a href="listing.html">Probolinggo</a></h3>
                                        <p>Constant care and attention to the patients makes good record</p>
                                    </div>
                                </div>
                            </div>                                              
