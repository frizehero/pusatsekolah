                                ...
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner bg-alternate">
                                        ...
                                        <div class="menu-header-content btn-pane-right">
                                            ...
                                            <div>
                                                <h5 class="menu-header-title">Bambang Dobol</h5>
                                            </div>
                                        ...
                                        <div class="widget-content">
                                            <div class="widget-content-wrapper">
                                                <div class="text-center">
                                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero libero sunt esse, a eum dolore et, voluptate placeat delectus nesciunt eaque fuga molestias ducimus animi. Earum reprehenderit nam totam assumenda?</p>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
