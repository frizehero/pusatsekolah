                        ...
                        <div class="modal-dialog w-100">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="h5 modal-title">Lupa Password?
                                        <h6 class="mt-1 mb-0 opacity-8">
                                            <span>Tolong masukan email yang kamu gunakan.</span>
                                        </h6>
                                    </div>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <h6 class="mb-0">
                                        <a href="<?php echo base_url('login/login' ) ?>" class="text-primary">Login menggunakan akun lain</a>
                                    </h6>
                                </div>
