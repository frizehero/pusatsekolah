<div class="app-main__inner">
                        ...
                        <div class="col-md-3" style="padding: 8px;">
                            <div class="card mb-3 widget-chart text-left">
                                <div class="icon-wrapper rounded-circle">
                                    ...
                                    <i class="pe-7s-look text-primary"></i>
                                </div>
                                <div class="widget-chart-content">
                                    <div class="widget-subheading">Jumlah Pengunjung</div>
                                    <div class="widget-numbers">45.452</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3" style="padding: 8px;">
                            <div class="card mb-3 widget-chart text-left">
                                <div class="icon-wrapper rounded-circle">
                                    ...
                                    <i class="lnr-graduation-hat text-success"></i>
                                </div>
                                <div class="widget-chart-content">
                                    <div class="widget-subheading">Sekolah Terdaftar</div>
                                    <div class="widget-numbers">85.090</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3" style="padding: 8px;">
                            <div class="card mb-3 widget-chart text-left">
                                ...
                                <div class="widget-chart-content">
                                    ...
                                    <div class="widget-numbers">205</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3" style="padding: 8px;">
                            <div class="card mb-3 widget-chart text-left">
                                ...
                                <div class="widget-chart-content">
                                    <div class="widget-subheading">Konfirmasi Sekolah</div>
                                    <div class="widget-numbers">874</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12 col-md-7 col-lg-8">
                            <div class="mb-3 card">
                                <div class="card-header-tab card-header">
                                    <div class="card-header-title font-size-lg text-capitalize font-weight-normal">Grafik Pengguna</div>
                                    <div class="btn-actions-pane-right text-capitalize">
                                        <button class="btn btn-warning">Reload</button>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12 col-md-7 col-lg-4">
                            <div class="card mb-3 widget-chart bg-arielle-smile" style="padding: 12px;">
                                <div class="widget-chart-content text-white">
                                    ...
                                    <div class="widget-subheading">Pengguna Harian</div>
                                </div>
                            ...
                            <div class="card mb-3 widget-chart card-hover-shadow-2x text-left">
                                ...
                                <div class="widget-chart-content">
                                    <div class="widget-numbers">633</div>
                                    <div class="widget-subheading">Pengguna Online</div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-6 col-xl-4">
                                <div class="mb-3 card">
                                        ...
                                        <div class="widget-chat-wrapper-outer">
                                            <div class="widget-chart-content widget-chart-content-lg">
                                                <div class="widget-chart-flex">
                                                    <div class="widget-title opacity-5 text-muted text-uppercase">Grafik Postingan Sekolah</div>
                                                </div>
                                                <div class="widget-numbers">
                                                    <div class="widget-chart-flex">
                                                        ...
                                                        <div class="widget-title ml-2 font-size-lg font-weight-normal text-muted">
                                                            <span class="text-danger pl-2">14% Turun</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="pt-2 pb-0 card-body">
                                        <h6 class="text-muted text-uppercase font-size-md opacity-9 mb-2 font-weight-normal">Sekolah</h6>
                                                ...
                                                <ul class="rm-list-borders rm-list-borders-scroll list-group list-group-flush">
                                                        ...
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <img width="38"  class="rounded-circle" src="assets/images/sekolah/logopaud1.png" alt="">
                                                                </div>
                                                                <div class="widget-content-left">
                                                                    <div class="widget-heading">PAUD Ananda 5</div>
                                                                    <div class="widget-subheading mt-1 opacity-10">
                                                                        <div class="badge badge-pill badge-dark">234 Update</div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <img style="height: 38px; width: 38px;"  class="rounded-circle" src="assets/images/sekolah/logosd1.png" alt="">
                                                                </div>
                                                                <div class="widget-content-left">
                                                                    <div class="widget-heading">SDN Sukabumi 2</div>
                                                                    <div class="widget-subheading mt-1 opacity-10">
                                                                        <div class="badge badge-pill badge-dark">180 Update</div>
                                                                    </div>
                                                                </div>
                                                                <div class="widget-content-right">
                                                                    <div class="fsize-1 text-focus">
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <img width="38" class="rounded-circle" src="assets/images/sekolah/logosd2.png" alt="">
                                                                </div>
                                                                <div class="widget-content-left">
                                                                    <div class="widget-heading">SDN Ardimulyo 1</div>
                                                                    <div class="widget-subheading mt-1 opacity-10">
                                                                        <div class="badge badge-pill badge-dark">165 Update</div>
                                                                    </div>
                                                                </div>
                                                                <div class="widget-content-right">
                                                                    <div class="fsize-1 text-focus">
