        ...
        <div class="container">
                    ...
                    <div class="user-profile-menu-wrap fl-wrap block_box">
                        ...
                        <div class="user-profile-menu">
                            ...
                            <ul class="no-list-style">
                                ...
                                <li><a href="<?php echo base_url('tampilan_hasilreport'); ?>" class="user-profile-act"><i class="fal fa-times-circle"></i> Hasil Report</a></li>
            ...
            <div class="col-md-9">
                <div class="dashboard-title   fl-wrap">
                    <h3>Daftar Oarng Yang Telah Direport</h3>
                </div>
                    ...
                    <div class="booking-list">
                        <div class="booking-list-message">
                            <div class="booking-list-contr">
                                <a href="#" class="color-bg tolt" data-microtip-position="left" data-tooltip="Batalkan"><i class="fal fa-trash"></i></a>
                            </div>
                            ...
                            <div class="booking-list-message-text">
                                ...
                                <div class="booking-details fl-wrap">
                                    <span class="booking-title">Tanggal Report :</span>
                                ...
                                <p>Berkomentar negatif yang dapat merusak nama baik institusi. </p>
                            </div>
                        </div>
                    </div>
                    <!-- dashboard-list end-->
                    ...
                    <div class="booking-list">
                        <div class="booking-list-message">
                            ...
                            <div class="booking-list-message-text">
                                ...
                                <span class="fw-separator"></span>
                                <p> Menggunakan akunnya untuk hal yang merugikan orang lain.</p>
                            </div>
                        </div>
                    </div>
                    <!-- dashboard-list end-->
