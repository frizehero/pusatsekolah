                        ...
                        <div class="container">
                            <nav class="scroll-nav">
                                <ul class="no-list-style">
                                    ...
                                    <li><a href="<?php echo base_url('nl_data_guru'); ?>"><i class="fal fa-info"></i>Guru</a></li>
                                    ...
                                    <li><a class="act-scrlink" href="<?php echo base_url('nl_produk_su'); ?>"><i class="fal fa-comments-alt"></i>Produk</a></li>
                                        ...
                                        <div class="listing-item-container init-grid-items fl-wrap nocolumn-lic">
                                            ...
                                            <div class="shop-item">
                                                ...
                                                <div class="shop-item_title">
                                                    <h4><a href="tampilan-detail-produk.html">Batik</a></h4>
                                                    <span class="shop-item_price">Rp. 50.000</span>
                                                    <a href="tampilan-detail-produk.html" class="shop-item_link color-bg">Details</a>
                                                </div>
                                            </div>
                                            <!-- shop-item end -->     
                                            <!-- shop-item  -->
                                            <div class="shop-item">
                                                ...
                                                <div class="shop-item_title">
                                                    ...
                                                    <span class="shop-item_price">Rp. 75.000</span>
                                            ...
                                            <div class="shop-item">
                                                ...
                                                <div class="shop-item_title">
                                                    ...
                                                    <span class="shop-item_price">Rp. 56.150</span>
                                                    <a href="product-single.html" class="shop-item_link color-bg">Details</a>
                                                </div>
                                            </div>
                                            <!-- shop-item end -->     
                                            ...
                                            <div class="shop-item">
                                                ...
                                                <div class="shop-item_title">
                                                    ...
                                                    <span class="shop-item_price">Rp. 15.200</span>
                                                    <a href="product-single.html" class="shop-item_link color-bg">Details</a>
                                                </div>
                                            </div>
                                            <!-- shop-item end -->                                            <!-- shop-item  -->
                                            <div class="shop-item">
                                                <div class="shop-item-media">
                                                    <a href="product-single.html">
                                                ...
                                                <div class="shop-item_title">
                                                    ...
                                                    <span class="shop-item_price">Rp. 7.500</span>
                                                    <a href="product-single.html" class="shop-item_link color-bg">Details</a>
                                                </div>
                                            </div>
                                            <!-- shop-item end -->     
                                            ...
                                            <div class="shop-item">
                                                ...
                                                <div class="shop-item_title">
                                                    ...
                                                    <span class="shop-item_price">Rp. 102.000</span>
                                                    <a href="product-single.html" class="shop-item_link color-bg">Details</a>
                                                </div>
                                            </div>
                                            <!-- shop-item end -->
                                            ...
                                            <div class="shop-item">
                                                ...
                                                <div class="shop-item_title">
                                                    <h4><a href="product-single.html">Saute Filet of Seabass</a></h4>
                                                    <span class="shop-item_price">Rp. 115.000</span>
                                                    <a href="product-single.html" class="shop-item_link color-bg">Details</a>
                                                </div>
                                            </div>
                                            <!-- shop-item end -->
                                            ...
                                            <div class="shop-item">
                                                ...
                                                <div class="shop-item_title">
                                                    ...
                                                    <span class="shop-item_price">Rp. 43.000</span>
                                                    <a href="product-single.html" class="shop-item_link color-bg">Details</a>
                                                </div>
                                            </div>
                                            <!-- shop-item end -->                                            
