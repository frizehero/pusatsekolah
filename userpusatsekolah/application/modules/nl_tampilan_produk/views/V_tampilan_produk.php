    ...
    <section class="gray-bg no-top-padding-sec" id="sec1">
        <div class="container">
            <div class="breadcrumbs inline-breadcrumbs fl-wrap block-breadcrumbs">
                <a href="#">Home</a><a href="#">Beranda</a> <span>Produk Sekolah</span>
                                    ...
                                    foreach ($tampil as $rowP) { ?>
                                        <div class="rooms-item fl-wrap">
                                            <div class="rooms-media">
                                                <img style="height: 150px;" src="http://localhost/pusatsekolah/pusatsekolah/assets/images/produk/<?php echo $rowP->foto_produk; ?>" alt="">
                                            </div>
                                            <div class="rooms-details">
                                                <div class="rooms-details-header fl-wrap">
                                                    <div class="row">
                                                        <div class="col-md-10">
                                                            <a href="<?php echo base_url('nl_beranda_su'); ?>">
                                                                <h3><?php echo $rowP->nama_produk; ?></h3>
                                                            </a>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="show-more-snopt"><i class="fal fa-ellipsis-h"></i></div>
                                                            <div class="show-more-snopt-tooltip">
                                                                <a href="tampilan-beranda-sekolah.html"> <i class="fas fa-comment-alt"></i> <?php echo $rowP->id_sekolah; ?>Lihat Lengkap</a>
                                                ...
                                                <p><?php echo $rowP->deskripsi_produk; ?></p>
                                            </div>
                                        </div>
                                    <?php $no++;
                                    } ?>
