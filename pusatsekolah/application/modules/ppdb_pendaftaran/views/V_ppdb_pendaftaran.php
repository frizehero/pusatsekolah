                    ...
                    <div class="mb-3 card">
                        ...
                        <div class="p-0 card-body">
                            <!-- <div class="dropdown-menu-header mt-0 mb-0">
                                <div class="dropdown-menu-header-inner bg-heavy-rain" style="height: 300px;">
                                    <div class="menu-header-image" style="background-image: url('assets/ppdb/2.jpg');"></div>
                                </div>
                            </div> -->
                                                                            ...
                                                                            <div class="widget-content p-0">
                                                                                <div class="widget-content-wrapper">
                                                                                    <div class="widget-content-left mr-3">
                                                                                        <img width="42" class="rounded-circle" src="assets/images/avatars/23.png" alt="">
                                                                                    </div>
                                                                                    <div class="widget-content-left">
                                                                                        <div class="widget-heading"><?php echo $rowP->nama_lengkap; ?></div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td class="text-left"><?php echo $rowP->nisn; ?></td>
                                                                        <td class="text-left"><?php echo $rowP->alamat_lengkap; ?></td>
                                                                        <td>
                                                                            <a href="<?php echo base_url('ppdb_pendaftaran/detailprofil/' . encrypt_url($rowP->id_pendaftaran)); ?>" class="btn btn-primary"><i class="fa fa-pen fa-w-16"></i>
                                                                            </a>
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <div class="modal fade" id="hapus<?php echo $no ?>" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <form action="<?php echo base_url('ppdb_pendaftaran/hapus') ?>" method="POST" enctype="multipart/form-data">
                                                                                        <div class="modal-body">
                                                                                            <!--Modal body-->
                                                                                            <p class="text-semibold text-main"></p>
                                                                                            <p>Anda Yakin Ingin Menghapus <b><?php echo $rowP->nama_lengkap ?></b> ? </p>

                                                                                            <input name="id" type="hidden" value="<?php echo $rowP->id_pendaftaran ?>" class="form-control">
                                                                                        </div>
