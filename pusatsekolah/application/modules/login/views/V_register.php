            ...
            <div class="h-100 bg-plum-plate bg-animation">
                <div class="d-flex h-100 justify-content-center align-items-center">
                    <div class="mx-auto app-login-box col-md-8">
                        <div>
                            <a href="">
                                <img src="<?php echo base_url() ?>assets/images/logo1.png" style="width: 150px; margin-left: 360px;">
                            </a>
                        </div>
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="position-relative form-group">
                                                <input name="passwordrep" id="examplePasswordRep" placeholder="Ulangi Password" type="password" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-3 position-relative form-check">
                                        <input name="check" id="exampleCheck" type="checkbox" class="form-check-input">
                                        <label for="exampleCheck" class="form-check-label">Saya Setuju <a href="javascript:void(0);">Syarat dan ketentuan</a>.</label>
                                    </div>
