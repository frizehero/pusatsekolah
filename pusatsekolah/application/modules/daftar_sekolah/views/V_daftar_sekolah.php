                                                        ...
                                                        <!--<div class="form-row">
                                                                ...
                                                                <div class="card mb-3 widget-content bg-plum-plate">
                                                                    <div class="widget-content-wrapper text-white">
                                                                        <div class="widget-content-left">
                                                                            ...
                                                                            <div class="widget-subheading">Upload foto yang menampilkan bagian utama sekolah</div>
                                                                            <br>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="card mb-3 widget-content bg-plum-plate">
                                                                    <div class="widget-content-wrapper text-white">
                                                                        <div class="widget-content-left">
                                                                            <div class="widget-heading">UPLOAD LOGO SEKOLAH</div>
                                                                            <div class="widget-subheading">Upload logo sekolah di sini</div>
                                                                            <br>
                                                                            <input name="file" type="file" class="form-control-file">
                                                                        </div>
                                                                    </div>
