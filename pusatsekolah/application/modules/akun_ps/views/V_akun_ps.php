                                        ...
                                        <div class="grid-menu grid-menu-2col">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="">
                                                        <button class="btn-icon-vertical btn-transition-text btn-transition btn-transition-alt pt-2 pb-2 btn btn-outline-focus"><i
                                                                class="lnr-sun text-primary opacity-7 btn-icon-wrapper mb-2"></i>Hapus Akun User
                                                        </button>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="no-gutters row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="">
                                                        <button class="btn-icon-vertical btn-transition-text btn-transition btn-transition-alt pt-2 pb-2 btn btn-outline-focus"><i
                                                                class="lnr-magic-wand text-primary opacity-7 btn-icon-wrapper mb-2"></i>Cek Akun User
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
