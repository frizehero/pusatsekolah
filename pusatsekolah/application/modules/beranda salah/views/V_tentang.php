                                    ...
                                    <div class="col-md-8">
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="tab-eg8-0" role="tabpanel">
                                                        ...
                                                        <div class="clearfix">
                                                            <button type="button" class="btn mr-2 mb-2 btn-shadow btn-wide float-right btn-pill btn-hover-shine btn btn-primary" data-toggle="modal" data-target="#exampleModal">Edit</button>
                                                        </div>
                                                    </div>
