                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <small class="form-text" style="color: Tomato;"><b>Size : S x S, Format : PNG</b></small><br>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <small class="form-text" style="color: Tomato;"><b>Size : 1070 x 290</b></small><br>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-row">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <select name="prov" class="form-control" id="provinsi">
                                                                    <option value="<?php echo $tampilkompetensi['provinsi_sekolah']?>"><?php echo $tampilkompetensi['provinsi']?></option>
                                                                    <?php 
