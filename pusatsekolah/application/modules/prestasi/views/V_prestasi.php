<div class="app-main__inner">
    ...
    <div class="row">
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="card-shadow-primary card-border text-dark mb-3 card">
                <div class="dropdown-menu-header">
                    <div class="dropdown-menu-header-inner" style="background-image: url('assets/images/dropdown-header/city3.jpg');">
                                        ...
                                        <table class="align-middle mb-0 table table-borderless" style="background-color: rgba(255 255 255 1); color: b">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-left">Non-Akademik</td>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center text-muted">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left">12-12-12012</td>
                                                </tr>
                                                </tr>
                                            </tbody>
                                        </table>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="card-shadow-primary card-border text-dark mb-3 card">
                <div class="dropdown-menu-header">
                    <div class="dropdown-menu-header-inner" style="background-image: url('assets/images/dropdown-header/city1.jpg');">
                        <div class="menu-header-btn-pane pt-5">
                            <div class="pt-5">
                                <div class="pt-5">
                                    <div class="widget-content p-1">
                                        ...
                                        <table class="align-middle mb-0 table table-borderless" style="background-color: rgba(255 255 255 1); color: b">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left">12-12-2013</td>
                                                </tr>
                                                </tr>
                                            </tbody>
                                        </table>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="card-shadow-primary card-border text-dark mb-3 card">
                <div class="dropdown-menu-header">
                    <div class="dropdown-menu-header-inner" style="background-image: url('assets/images/dropdown-header/city2.jpg');">
                        <div class="menu-header-btn-pane pt-5">
                            <div class="pt-5">
                                <div class="pt-5">
                                    <div class="widget-content p-1">
                                        ...
                                        <table class="align-middle mb-0 table table-borderless" style="background-color: rgba(255 255 255 1); color: b">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left">05-03-2019</td>
                                                </tr>
                                                </tr>
                                            </tbody>
                                        </table>
