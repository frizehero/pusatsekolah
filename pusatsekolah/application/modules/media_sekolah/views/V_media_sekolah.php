...
<?php tampilnotif()?>
            ...
            <ul class="tabs-animated-shadow tabs-animated nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="btn-actions-pane-right text-capitalize">
                        <a href="<?php echo base_url('media_sekolah/tambahview'); ?>">
                                            ...
                                            <div class="btn-actions-pane-right text-capitalize actions-icon-btn">
                                                <div class="btn-group dropdown">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        ...
                                                        <form action="<?php echo base_url('media_sekolah/hapus') ?>" method="POST" enctype="multipart/form-data">
    ...
    <!-- <div class="mb-3 card">
        <div class="card-body">
            <ul class="tabs-animated-shadow tabs-animated nav">
                <li class="nav-item">
                    <a role="tab" class="nav-link active" id="tab-c-2" data-toggle="tab" href="#tab-animated-0">
                        <span>Video</span>
                    </a>
                </li>
                    <div class="btn-actions-pane-right text-capitalize">
                        <a href="<?php echo base_url('media/tambahvidio'); ?>">
                            <button class="mb-2 mr-2 border-0 btn-transition btn btn-outline-link">Tambah Video</button>
                        </a>
                    </div>
            </ul>
            <div class="tab-content">
                                            ...
                                            <div class="btn-actions-pane-right text-capitalize actions-icon-btn">
                                                <div class="btn-group dropdown">
                                                    ...
                                                    <div tabindex="-1" role="menu" aria-hidden="true"
                                                        class="dropdown-menu-right rm-pointers dropdown-menu-shadow dropdown-menu-hover-link dropdown-menu">
                                                        <button class="dropdown-item" data-toggle="modal" data-target="#hapus<?php echo $no ?>">
                                                            <i class="fa fa-trash fa-w-16"></i>&nbsp;<span>Hapus Vidio</span>
                                                        </button>
                                                        <button type="button" tabindex="0" class="dropdown-item">
                                                            <i class="lnr-download"></i>&nbsp;<span>Download Vidio</span>
                                                        </button>
                                                    </div> -->
                                                    <!-- Modal HAPUS -->
                                                    <!-- <div class="modal fade" id="hapus<?php echo $no ?>"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel" style="color: black;">Hapus Vidio Sekolah?</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        ...
                                                        <div class="modal-body"> -->
                                                            <!--Modal body-->
                                                            <!-- <p class="text-semibold text-main"></p>
                                                            <p style="color: black;">Anda Yakin Ingin Menghapus Vidio Sekolah <b><?php echo $rowP->vidio_media ?></b> ? </p>
